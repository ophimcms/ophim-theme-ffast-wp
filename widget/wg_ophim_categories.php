...
class WG_oPhim_Categories extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <?php if ($query->have_posts()) :
            if($style == 1 ){
                include THEME_URL.'/templates/section/poster_1.php';
            }
            if($style == 2 ){
                include THEME_URL.'/templates/section/poster_2.php';
            }
            if($style == 3 ){
                include THEME_URL.'/templates/section/thumb.php';
            }
            if($style == 4 ){
                include THEME_URL.'/templates/section/thumb_theater.php';
            }
            if($style == 5 ){
                include THEME_URL.'/templates/section/thumb_top.php';
            }
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <br>
            <?php
            $f = array( '1' => __('Poster 1', 'ophim'), '2' => __('Poster 2', 'ophim'), '3' => __('Thumb', 'ophim'), '4' => __('Thumb Theater', 'ophim'), '5' => __('Thumb Top', 'ophim'));
            foreach ($f as $x => $n ) { ?>
